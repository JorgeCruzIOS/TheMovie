...
public protocol ListVideoMovieServiceProtocol{
    typealias Request = BaseRequestEmpty?
    typealias Response = ListVideoMovieResponse?
}

internal class ListVideoMovieService:ListVideoMovieServiceProtocol {
    private var servicesManager = GServicesSingleton.shareManager
    private var rootPath : String = ""
    private var basePath : String = ""
    private var endpoint : String = ""
    
    init(base:String, endPoint: Int){
